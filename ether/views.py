...
def home(request):
    return render(request,'ether/index.html')
def signup(request):
    if request.method == 'POST':
        ...
        subject = "Welcome To Ether,  Login!"
        ...
        email_subject = "Confirm Your email @ ether - Django Login!! "
    ...
    return render(request,'ether/signup.html')
def signin(request):
    if request.method == 'POST':
        username = request.POST['username']
        pass1 = request.POST['pass1']
        ...
        if user is not None:
            ...
            return render(request, "ether/index.html", {'fname': fname})
        else:
            messages.error(request, "Bad Credentials")
            return redirect('home')
    return render(request,'ether/signin.html')
def signout(request):
    logout(request)
